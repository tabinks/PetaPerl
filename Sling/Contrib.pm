...
sub ContribVolbl {
	...
	if (Sling::PdbContainsAA::PdbContainsAA($PDB)) {
	    print STDERR "Sling::Contrib - Creating clean pdbfile\n";
	...
	# Calcuation
	print STDERR "Sling::Contrib - Performing volbl calculation 1\n";
	`$CMD{'PDB2GALF_LINUX'} $pdb_file $p_name`;
	print STDERR "Sling::Contrib - Performing volbl calculation: $pdb_file $p_name\n";
	`$CMD{'DELCX_LINUX'} $p_name > /dev/null`;
	print STDERR "Sling::Contrib - Performing volbl calculation 3\n";
	`$CMD{'MKALF_LINUX'} $p_name > /dev/null`;
	print STDERR "Sling::Contrib - Performing volbl calculation 4\n";
	`$CMD{'VOLBL_LINUX'}  -s 1 -c 0 -p $pdb_file $p_name > $p_out`;
	print STDERR "Sling::Contrib - Performing volbl calculation 5\n";
